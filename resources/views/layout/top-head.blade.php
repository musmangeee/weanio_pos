        ...
        <nav class="navbar">
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <span class="brand-big">@if($general_setting->site_logo)<img src="{{url('public/logo', $general_setting->site_logo)}}" width="300">&nbsp;&nbsp;@endif<h1 class="d-inline">{{$general_setting->site_title}}</h1></span>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-6 text-right">
              <p>{{trans('file.Developed')}} {{trans('file.By')}} <a href="https://www.weanio.com/" class="external">Weanio Technologies</a></p>
            </div>
          </div>
        </div>
      </footer>
